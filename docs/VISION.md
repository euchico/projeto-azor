...
Este documento descreve a **visão geral** do Projeto Azor.  
Seu objetivo é servir como um **ponto de referência estável**, ajudando a manter clareza sobre o propósito do projeto ao longo do tempo.

Este documento **não descreve requisitos técnicos**, nem funcionalidades detalhadas.  
Ele existe para esclarecer os seguintes pontos:
...
O **Projeto Azor** consiste em um sistema ERP desenvolvido para uso pessoal, criado como iniciativa de aprendizado e aplicação prática para explorar o ecossistema .NET.
